...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (firstName.value && surName.value && email.value && message.value && !nameError.textContent && !surNameError.textContent && !emailError.textContent && !messageError.textContent) {
